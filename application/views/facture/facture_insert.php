...
<div class="container">
 ...
 <div class="row">
      ...
      <div style="width: 500px;position: relative;top: 5%;margin-left: 0px;">
      ...
      <form method="post" action="<?php echo base_url()?>index.php/facture/factureinsert">
        ...
        <?php foreach($etat_facture as $fr) : ?>
         ...
         <div style="width: 300px;position: absolute;top: 200px">
           ...
           <div class="form-group" style="position: absolute;left:420px;" >  
                <input type="submit" name="valider" value="Valider" class="btn btn-secondary" /> 
                <input style="position: absolute;float: right;margin-left: 10px;" type="submit" name="retour" value="Retour" class="btn btn-secondary" />  
           </div>      
